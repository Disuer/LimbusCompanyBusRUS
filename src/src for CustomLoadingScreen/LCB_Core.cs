...
namespace LimbusMODS
{
    ...
    public class LCB_Core : BasePlugin
    {
        ...
        public static string my_uri = "https://raw.githubusercontent.com/Disuer/LimbusCompanyBusRUS/master_ilcpp/src/config.json";
        ...
        public override void Load()
        {
            ...
            string filename = ModPath + "/config.json";
            LogError(AUTHOR);
            ...
            try
            {
                ...
                harmony.PatchAll(typeof(LCB_ModApplier));
            }
            catch (Exception e)
            {
                LogError(e.ToString());
